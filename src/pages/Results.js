...
export default function Results() {
 ...
 const [wordSentence, setWordSentence] = useState([]);
  ...
  useEffect(() => {
    fetch(
      `https://www.learnerai.theall.ai/lais/scores/GetTargets/session/${localStorage.getItem(
  ...
  const GetRecommendedWordsAPI = () => {
    ...
    fetch(
      `https://www.learnerai.theall.ai/lais/scores/GetFamiliarity/session/${localStorage.getItem(
        'virtualStorySessionID'
      )}`
    )
      .then(res => {
