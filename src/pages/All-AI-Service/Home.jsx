...
function Home() {
  ...
  const getfromurl = () => {
    const filePath = "https://telemetry-dev.theall.ai/content-service/v1/WordSentence/pagination?page=1&limit=10&type=Sentence&collectionId=05b3f97b-4bc2-4b97-8f43-fddbe8a0a215";
...
// console.log(res.data.data);
  ...
  useEffect(() => {
    console.log("useEffect getfromurl");
    getfromurl();
  }, [sel_level]);
