...
const completionCriteria = {
  ...
  "m4": [
    ...
    { title: 'P3', criteria: 'para', template: 'simple' },
    { title: 'P4', criteria: 'para', template: 'simple' },
    { title: 'S1', criteria: 'para', template: 'simple' },
    { title: 'P5', criteria: 'sentence', template: 'simple' },
    { title: 'P6', criteria: 'para', template: 'simple' },
    { title: 'P7', criteria: 'para', template: 'simple' },
    { title: 'P8', criteria: 'para', template: 'simple' },
    { title: 'S2', criteria: 'para', template: 'simple' }
  ],
  "m5": [
    { title: 'P1', criteria: 'sentence', template: 'simple' },
    { title: 'P2', criteria: 'para', template: 'simple' },
    { title: 'P3', criteria: 'para', template: 'simple' },
    { title: 'P4', criteria: 'para', template: 'simple' },
    { title: 'S1', criteria: 'para', template: 'simple' },
    { title: 'P5', criteria: 'sentence', template: 'simple' },
